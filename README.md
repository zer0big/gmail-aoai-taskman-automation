...
**버전**: v2.8.0 | **최종 업데이트**: 2026-02-22 | **담당자**: 김영대 (your-email@example.com) | **상태**: ✅ 운영 중
...
| 버전 | 날짜 | 변경 내용 |
|------|------|----------|
| **v2.8.0** | 2026-02-22 | PIM digest + 중복 방지 + 필터 확장 (v1.5.0) |
| v2.7.0 | 2026-02-16 | 발신자 4건 추가, 제목 키워드 제외 필터 (v1.4.0) |
